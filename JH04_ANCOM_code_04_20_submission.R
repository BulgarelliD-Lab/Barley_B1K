...
#file "Map_JH04_24_L2.txt"  is  worksheet 12 in Supplementary Dataset 1
#file "Map_ANCOM.txt" reduced version of mapping file for main analysis 
#Samples names need to be written as "Sample.ID" is worksheet 13 in Supplementary Dataset 1
...
# the above output is saved as worksheet 14 in Supplementary dataset 1
