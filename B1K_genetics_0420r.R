...
#import the genetic distance
#this file is named Supplementary worksheet ws 14 in Supplementary Dataset 1
...
#this file is named Supplementary worksheet ws 15 in Supplementary Dataset 1
