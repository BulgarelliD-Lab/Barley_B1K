...
if (!requireNamespace("BiocManager", quietly = TRUE,lib="Z:/R-3.5.0/library"))
  install.packages("BiocManager")

BiocManager::install("'harrietr", dependencies= TRUE)
...
#file JH04_otu_table_SILVA132_97_24_nc2_woc_nch_nmi.txt is Supplementary worksheet ws1 in Additional File 2
...
#design file
#file JH04_otu_table_SILVA132_97_24_nc2_woc_nch_nmi.txt is Supplementary worksheet ws2 in Additional File 2
...
kruskal.test(Stemdryweight ~ Description, data =design_rhizo )
...
kruskal.test(Rootshoot ~ Description, data =design_rhizo )
...
#file Geo_otu_table_L2.txt is Supplementary worksheet ws3 in Additional File 2
...
#OK due to size limits the legend covers part of the graph, save the graph as .eps file and in illustrator uou can adjust this (and other)  graphical issues
...
###########################################
#Figure 3; Additional File 1 Figure S2 & S3
###########################################
...
##########
#Figure Additional File 1 Figure S2
##########
...
DESeq_OUTPUT_enriched_rhizo_FDR005_D1_M_taxonomy <- cbind.data.frame (D1_enriched_vs_M_FDR_005_2, (dat_tax_noPlants[D1_enriched_vs_M_FDR_005_2, ]))
#write.table(DESeq_OUTPUT_enriched_rhizo_FDR005_D1_M_taxonomy, file="DESeq_OUTPUT_enriched_rhizo_FDR005_D1_M_taxonomy.txt")
DESeq_OUTPUT_enriched_rhizo_FDR005_M_D1_taxonomy <- cbind.data.frame (M_enriched_vs_D1_FDR_005_2,(dat_tax_noPlants[M_enriched_vs_D1_FDR_005_2,]))
#write.table(DESeq_OUTPUT_enriched_rhizo_FDR005_M_D1_taxonomy, file="DESeq_OUTPUT_enriched_rhizo_FDR005_M_D1_taxonomy.txt")
...
DESeq_OUTPUT_enriched_rhizo_FDR005_D2_M_taxonomy <-cbind.data.frame(D2_enriched_vs_M_FDR_005_2, (dat_tax_noPlants[D2_enriched_vs_M_FDR_005_2, ]))
#write.table(DESeq_OUTPUT_enriched_rhizo_FDR005_D2_M_taxonomy, file="DESeq_OUTPUT_enriched_rhizo_FDR005_D2_M_taxonomy.txt")
DESeq_OUTPUT_enriched_rhizo_FDR005_M_D2_taxonomy <- cbind.data.frame(M_enriched_vs_D2_FDR_005_2,(dat_tax_noPlants[M_enriched_vs_D2_FDR_005_2, ]))
#write.table(DESeq_OUTPUT_enriched_rhizo_FDR005_M_D2_taxonomy, file="DESeq_OUTPUT_enriched_rhizo_FDR005_M_D2_taxonomy.txt")
...
DESeq_OUTPUT_enriched_rhizo_FDR005_C1_M_taxonomy <- cbind.data.frame(C1_enriched_vs_M_FDR_005_2, (dat_tax_noPlants[C1_enriched_vs_M_FDR_005_2, ]))
#write.table(DESeq_OUTPUT_enriched_rhizo_FDR005_C1_M_taxonomy, file="DESeq_OUTPUT_enriched_rhizo_FDR005_C1_M_taxonomy.txt")
DESeq_OUTPUT_enriched_rhizo_FDR005_M_C1_taxonomy <- cbind.data.frame(M_enriched_vs_C1_FDR_005_2,(dat_tax_noPlants[M_enriched_vs_C1_FDR_005_2, ]))
#write.table(DESeq_OUTPUT_enriched_rhizo_FDR005_M_C1_taxonomy, file="DESeq_OUTPUT_enriched_rhizo_FDR005_M_C1_taxonomy.txt")
...
DESeq_OUTPUT_enriched_rhizo_FDR005_C2_M_taxonomy <- cbind.data.frame(C2_enriched_vs_M_FDR_005_2, (dat_tax_noPlants[C2_enriched_vs_M_FDR_005_2, ]))
#write.table(DESeq_OUTPUT_enriched_rhizo_FDR005_C2_M_taxonomy, file="DESeq_OUTPUT_enriched_rhizo_FDR005_C2_M_taxonomy.txt")
DESeq_OUTPUT_enriched_rhizo_FDR005_M_C2_taxonomy <- cbind.data.frame (M_enriched_vs_C2_FDR_005_2,(dat_tax_noPlants[M_enriched_vs_C2_FDR_005_2, ]))
#write.table(DESeq_OUTPUT_enriched_rhizo_FDR005_M_C2_taxonomy, file="DESeq_OUTPUT_enriched_rhizo_FDR005_M_C2_taxonomy.txt")
...
DESeq_OUTPUT_enriched_rhizo_FDR005_M_N_taxonomy <- cbind.data.frame(M_enriched_vs_N_FDR_005_2, (dat_tax_noPlants[M_enriched_vs_N_FDR_005_2, ]))
#write.table(DESeq_OUTPUT_enriched_rhizo_FDR005_M_N_taxonomy, file="DESeq_OUTPUT_enriched_rhizo_FDR005_M_N_taxonomy.txt")
DESeq_OUTPUT_enriched_rhizo_FDR005_N_M_taxonomy <- cbind.data.frame(N_enriched_vs_M_FDR_005_2, (dat_tax_noPlants[N_enriched_vs_M_FDR_005_2, ]))
#write.table(DESeq_OUTPUT_enriched_rhizo_FDR005_N_M_taxonomy, file="DESeq_OUTPUT_enriched_rhizo_FDR005_N_M_taxonomy.txt")
